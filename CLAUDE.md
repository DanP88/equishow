...
> MAJ : 2026-07-29 · repo `fix/drop-profiles-roles-103` @ `3a54b81` · migrations fichiers → **103** (…103 appliquées prod). **1 PR ouverte : #100 (mig 103, non mergée).**
...
🟢 **code prêt** / 🔴 **infra commerciale non prête**. `fix/drop-profiles-roles-103` @ `3a54b81`, **1 PR ouverte : #100 (mig 103, appliquée prod, non mergée)**.
