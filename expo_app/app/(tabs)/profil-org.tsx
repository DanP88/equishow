      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.statsRow}>
          <TouchableOpacity style={{ flex: 1 }} onPress={() => router.push('/(tabs)/org-concours-list?tab=en_cours')}>
            <StatBox label="Concours en cours" value={2} icon="🏆" />
          </TouchableOpacity>
          <View style={styles.statsDivider} />
          <TouchableOpacity style={{ flex: 1 }} onPress={() => router.push('/(tabs)/org-concours-list?tab=passe')}>
            <StatBox label="Concours organisé" value={18} icon="✓" />
          </TouchableOpacity>
          <View style={styles.statsDivider} />
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.menuBtn} onPress={() => router.push('/compte-type')} activeOpacity={0.7}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.menuSublabel}>Organisateur</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  roleBadge: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, marginTop: Spacing.md, backgroundColor: Colors.primaryLight, borderRadius: 999, paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs },
