  ...
  return (
    <SafeAreaView style={styles.root}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>👥 Communauté Coachs</Text>
        <Text style={styles.headerSub}>Partages, conseils et discussions entre coachs</Text>
      </View>
